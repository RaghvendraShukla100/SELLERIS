...
function Footer() {
  return (
    <footer className="bg-[#232f3f] text-gray-100 mt-20 py-10">
      <div className="w-9/12   mx-auto  grid grid-cols-4">
        <div className="">
          <h2 className="font-semibold uppercase my-5">get to know us</h2>
          <div className="  capitalize">
            <ul>
              <li className="hover:underline cursor-pointer">about selleris</li>
        ...
        <div>
          ...
          <div className="  capitalize">
            <ul>
              <li className="hover:underline cursor-pointer">your accounts</li>
